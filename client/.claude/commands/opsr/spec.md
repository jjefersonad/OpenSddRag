...
Invoke the `opensddrag-spec` skill (Claude Code auto-loads it from `.claude/skills/opensddrag-spec/SKILL.md` via the slash command; OpenCode loads it from `.opencode/skills/opensddrag-spec/SKILL.md` via the `skill` tool).
