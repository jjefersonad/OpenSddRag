...
Invoke the `opensddrag-archive` skill (Claude Code auto-loads it from `.claude/skills/opensddrag-archive/SKILL.md` via the slash command; OpenCode loads it from `.opencode/skills/opensddrag-archive/SKILL.md` via the `skill` tool).
