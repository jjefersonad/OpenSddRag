...
Invoke the `opensddrag-status` skill (Claude Code auto-loads it from `.claude/skills/opensddrag-status/SKILL.md` via the slash command; OpenCode loads it from `.opencode/skills/opensddrag-status/SKILL.md` via the `skill` tool).
